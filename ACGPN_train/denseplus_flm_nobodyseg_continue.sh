...
python train.py --dataroot ../../train_data/  --gpu_ids 0,1,2,3 --niter 10 --niter_decay 10 --batchSize 4 --denseplus --nobodyseg --landmarks --name denseplus_flm_nobodyseg --continue_train
